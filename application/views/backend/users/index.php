...
<?php endforeach; ?>
													...
													<td><?php echo ($user->active) ? anchor('backend/users/deactivate/' . $user->id, '{lang_active}', $user_active) : anchor('backend/users/activate/'. $user->id, '{lang_inactive}', $user_inactive); ?></td>
													<td>
														...
														<?php echo anchor('#' . $user->id, '{lang_delete}', array('class' => 'btn btn-danger btn-sm', 'role' => 'button')); ?>
													</td>
												</tr>
<?php endforeach; ?>
											</tbody>
